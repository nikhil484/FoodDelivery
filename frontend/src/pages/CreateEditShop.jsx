          ...
          <div className='text-3xl font-extrabold text-gray-900'>
           ...
           <form className='space-y-5' onSubmit={handleSubmit}>
            ...
            <div>
              ...
              focus:outline-none focus:ring-2 focus:ring-orange-500' onChange={(e)=>setState(e.target.value)} value={state}/>
                </div>
              ...
              focus:outline-none focus:ring-2 focus:ring-orange-500' onChange={(e)=>setCity(e.target.value)} value={city}/></div>
              </div>
            <div>
