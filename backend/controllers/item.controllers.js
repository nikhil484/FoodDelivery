...
export const addItem = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: `add item error ${error}` })
    }
}
...
export const editItem = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: `edit item error ${error}` })
...
export const getItemById = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: `get item error ${error}` })
    }
}
...
export const deleteItem = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: `delete item error ${error}` })
    }
...
export const getItemByCity = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: `get items in city error ${error}` })
    }
}
...
export const serachItems = async (req, res) => {
    try {
...
try {
    ...
    if(!itemId || !rating){
        return res
        .status(400)
        .json({message:"item id and rating is required "})
  ...
  return res
  .status(500)
   .json({ message: `rating items error ${error}` })
}
